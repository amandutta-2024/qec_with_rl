...
class DecoderTests(unittest.TestCase):
    def test_lookup_actions_match_expected_table(self) -> None:
        """The 3-qubit lookup decoder should match the known correction table."""
        expected = {
            (0, 0): 0,
            (1, 0): 1,
            (1, 1): 2,
    ...
    def test_lookup_policy_has_all_syndromes(self) -> None:
        """The 3-qubit lookup policy should cover all four syndromes."""
    ...
    def test_lookup_policy_covers_nine_qubit_syndromes(self) -> None:
        """The 9-qubit lookup policy should cover the full syndrome space."""
